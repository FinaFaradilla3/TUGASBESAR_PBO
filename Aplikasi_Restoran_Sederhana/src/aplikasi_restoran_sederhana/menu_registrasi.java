...
public class menu_registrasi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btn_input, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                ...
                .addGap(37, 37, 37)
                .addComponent(btn_menu_masakan, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(text_password, javax.swing.GroupLayout.DEFAULT_SIZE, 489, Short.MAX_VALUE)
                            .addComponent(combo_id_level, 0, 489, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btn_menu_transaksi, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(text_id_user, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(text_nama_user, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_inputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inputActionPerformed
        ...
        String selectedLevel = (String) combo_id_level.getSelectedItem();

        // Validasi nilai combo box
        if (selectedLevel == null || selectedLevel.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Silakan pilih ID Level terlebih dahulu!");
            return; // Berhenti jika ID Level belum dipilih
        }

        // Membuat objek user dan mengisi nilai dari form
        user u = new user();
        u.username = text_username.getText();
        u.password = text_password.getText();
        u.nama_user = text_nama_user.getText();

        // Validasi input lainnya
        if (u.username.isEmpty() || u.password.isEmpty() || u.nama_user.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Semua field harus diisi!");
            return; // Berhenti jika ada field kosong
        }

        // Siapkan query untuk memasukkan data
        this.stat = k.getCon().prepareStatement("insert into user (username, password, nama_user, id_level) values (?, ?, ?, ?)");

        // Masukkan data ke dalam query
        stat.setString(1, u.username);
        stat.setString(2, u.password);
        stat.setString(3, u.nama_user);
        stat.setString(4, selectedLevel); // Ambil ID Level dari combo box
        
        // Eksekusi query
        stat.executeUpdate();

        // Refresh tabel setelah input data
        refreshTable();
...
//        try {
//        // Ambil nilai dari combo box
//        String selectedLevel = combo_id_level.getSelectedItem().toString();
//
//        // Membuat objek user dan mengisi nilai dari form
//        user u = new user();
//        
...
//        
//        // Masukkan data ke dalam query
//        stat.setString(1, u.username); // username dari text_username
//        stat.setString(2, u.password); // password dari text_password
//        stat.setString(3, u.nama_user); // nama_user dari text_nama_user
//        stat.setString(4, selectedLevel); // id_level dari combo box
//        
//        // Eksekusi query
//        stat.executeUpdate();
//        refreshTable(); // Refresh tabel setelah input data
//        JOptionPane.showMessageDialog(null, "Data berhasil ditambahkan!");
//
//    } catch (Exception e) {
//        JOptionPane.showMessageDialog(null, e.getMessage());
...
//        }
    ...
    public javax.swing.JComboBox<String> combo_id_level;
